...
const Navbar: React.FC = () => {
    ...
    const { userType, userProfilePic } = profileContext;
    ...
    const handleAvatarClick = (e: React.MouseEvent<HTMLElement>) => setAnchorElUser(e.currentTarget);
    ...
    const handleOpenNav = (e: React.MouseEvent<HTMLElement>) => setAnchorElNav(e.currentTarget);
    ...
    const teacherMenu = [
        ...
        {
            menuId: 3,
            menuName: "Meus Cursos",
            menuRoute: "/my-courses"
        },
        {
            menuId: 4,
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: { xs: 1.5, md: 3 } }}>
                    ...
                    {isSmUp ? (
                        ...
                        <Box>
                            ...
                            >
                                {renderMenu.map((menu) =>
                                    <MenuItem key={menu.menuId} onClick={() => handleNavigate(menu.menuRoute)}>{menu.menuName}</MenuItem>
                                )}
                            </Menu>
                        </Box>
                    )}
                    ...
                    { (userType && userType === 'S') &&
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {loadingXp ? <Skeleton variant="text" width={60} sx={{ bgcolor: "rgba(255,255,255,0.12)" }} /> : `Nível ${level}`}
                                </Typography>
